...
document.getElementById('clear').addEventListener('click',
   function() {
       ...
       console.log("The user cleared the amount of flips")
   }
)
...
document.getElementById('Flip').addEventListener('click',
   function() { 
       ...
       updateDisplay()
       console.log("True = Heads False = Tails")
    console.log("The user has flipped the coin: " + totalFlipCount + " time." + " The user got " + x)
})
